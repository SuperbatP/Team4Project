...
public class ReservationController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "reservation/reservationList.wow")
    public String reservationList(Model model, String searchWord){
        List<DoctorsVO> doctorsList = doctorsDao.getDocList(searchWord);
