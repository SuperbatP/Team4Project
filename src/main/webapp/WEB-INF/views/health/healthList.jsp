...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <form name="search" action="healthList.wow" method="post" class="form-horizontal">
                <sec:csrfInput/>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <c:forEach items="${freeBoardList }" var="freeBoard">
            <tr class="text-center">
                ...
                <td class="text-left">
                    <a href="healthView.wow?boNo= ${freeBoard.boNo }">
                            ${freeBoard.boTitle }
                    </a>
                </td>
    ...
    <nav class="text-center">
        <ul class="pagination">
            ...
            <!-- 첫 페이지  -->
            <li><a href="healthList.wow?curPage=1" data-page="1"><span aria-hidden="true">&laquo;</span></a></li>

            <!-- 이전 페이지 -->
            <c:if test="${freeBoardVO.firstPage>1}">
                <li><a href="healthList.wow?curPage=${freeBoardVO.curPage-1}" data-page=""><span aria-hidden="true">&lt;</span></a></li>
            </c:if>
            ...
            <c:forEach var="i" begin="${freeBoardVO.firstPage}" end="${freeBoardVO.lastPage}">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <a href="healthList.wow?curPage=${i}" data-page="${i}">${i}</a>
                    </c:otherwise>
                </c:choose>
                </li>
            ...
            <c:if test="${freeBoardVO.lastPage < freeBoardVO.totalPageCount}">
                <li><a href="healthList.wow?curPage=${freeBoardVO.lastPage+1}" data-page="${freeBoardVO.lastPage+1}"><span aria-hidden="true">&gt;</span></a></li>
            </c:if>

            <!-- 마지막 페이지 -->
            <li><a href="healthList.wow?curPage=${freeBoardVO.totalPageCount}" data-page="${freeBoardVO.totalPageCount}"><span aria-hidden="true">&raquo;</span></a></li>
        </ul>
    </nav>
    <!-- END : 페이지네이션  -->
