...
<div class="container">
    <div class="page-header">
        <h3>
            건강정보 - <small>글 수정</small>
        </h3>
    </div>
    <form action="healthModify.wow" method="post" enctype="multipart/form-data">
        <sec:csrfInput/>
        ...
        <table class="table table-striped table-bordered">
            ...
            <tr>
                <td colspan="2">
                    <div class="pull-left">
                        <a href="healthList.wow" class="btn btn-default btn-sm"> <span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp;&nbsp;목록
                        </a>
                    </div>
                    <div class="pull-right">

                        <a href="healthList.wow" class="btn btn-info btn-sm"> <span class="glyphicon glyphicon-list" aria-hidden="true"></span> &nbsp;목록으로
                        </a>
                        ...
                        <button type="submit" formaction="healthDelete.wow" class="btn btn-sm btn-danger" onclick="return confirm('정말로 삭제 할까요??');">
